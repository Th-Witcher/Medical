...
public class ProfileFragment extends Fragment {
    ...
    TextView fname,lname,id,city,phone,mail,gender,patbithdate,state,jop,usermail,pasmail;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Paper.book().write(Email,usermail);
        ...
        fname=root.findViewById(R.id.patfname);
        lname=root.findViewById(R.id.patlname);
        id=root.findViewById(R.id.patid);
        city=root.findViewById(R.id.patcity);
        phone=root.findViewById(R.id.patientphone);
        mail=root.findViewById(R.id.patientmail);
        gender=root.findViewById(R.id.patgender);
        patbithdate=root.findViewById(R.id.patdate);
        state=root.findViewById(R.id.patstat);
        jop=root.findViewById(R.id.patjop);
        imageView1=root.findViewById(R.id.circleimage_pati);
        ...
        reference.child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                if (userprofile!=null)
                {
                    ...
                    phone.setText(userprofile.getNumber());
                    id.setText(userprofile.getNumber());
                    city.setText(userprofile.getCity());
                    gender.setText(userprofile.getGender());
                    patbithdate.setText(userprofile.getBirthdate());
                    state.setText(userprofile.getState());
                    jop.setText(userprofile.getJoptitle());
                    if(userprofile.getImageurl().equals("default")){
                        ...
                        Glide.with(getActivity().getApplicationContext()).load(userprofile.getImageurl()).into(imageView1);
            ...
            storageTask.continueWithTask((Continuation<UploadTask.TaskSnapshot, Task<Uri>>)task ->{
                ...
                public void onComplete(@NonNull @NotNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()){
                        ...
                        patient.setImageurl(sDownloaduri);
                        reference.child(user.getUid()).child("imageurl").setValue(patient.getImageurl());
                        Glide.with(getActivity().getApplicationContext()).load(patient.getImageurl()).into(imageView1);

                        final DatabaseReference profileimagerefrence=FirebaseDatabase.getInstance().getReference("pic").child(user.getUid());
                        profileimagerefrence.push().setValue(patient).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
